...
?>
    ...
    <head>
        ...
        <title id="title">Product Management</title>
    ...
    <body>
        <div id="wrapper">
            ...
            <main id="main">
                <h1 class=pageTitle>Product Management</h1>
                <h2>
                    <?php
                    if (isset($message)) {
                        echo $message;
                ...
                <ul>
                    <li><a href="../products/index.php?action=category">Add a New Category</a></li>
                    <li><a href="../products/index.php?action=product">Add a New Product</a></li>
                </ul>
            </main>
